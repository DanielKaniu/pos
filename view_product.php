              ...
              <?php
                ...
                <div class="col-md-6">
                  <ul class="list-group">
                    ...
                    <li class="list-group-item"><b>Buying Price</b>  :<span class="label label-warning pull-right">Kes <?php echo number_format($row->purchase_price); ?></span></li>
                    <li class="list-group-item"><b>Selling Price</b>     :<span class="label label-warning pull-right">Kes <?php echo $row->sell_price; ?></span></li>
                    <li class="list-group-item"><b>Profit</b>           :<span class="label label-success pull-right">Kes <?php echo number_format(($row->sell_price - $row->purchase_price)); ?></span></li>
                ...
                <div class="col-md-6">
                  <ul class="list-group">
                    <center><p class="list-group-item list-group-item-success">Product Pictures</p></center>
                    <img src="uploads/<?php echo $row->img?>" alt="Product Image" class="img-responsive">
                  </ul>
                </div>
              <?php
                }
