...
$pdf->Cell(60,10,'SOKO MOTO CO. LTD',0,1,'C');

$pdf->Line(10,18,72,18);
$pdf->Line(10,19,72,19);

$pdf->SetFont('Arial','',8);
$pdf->Cell(60,3,'Address: Kiserian, Mutall Business Center',0,1,'C');

$pdf->SetFont('Arial','',8);
$pdf->Cell(63,3,'Selling Shop Items',0,1,'C');

$pdf->SetFont('Arial','',8);
$pdf->Cell(63,4,'Telephone: +254779453366',0,1,'C');
...
$pdf->Cell(20,4 ,'Note number  :    ',0,0,'C');
...
$pdf->Cell(1,8 ,'Kes ' . number_format($row->total),0,1,'C');
...
$pdf->SetFont('Arial','BI',7);
$pdf->Cell(1,4 ,'Kes                                                                                                                                                '. number_format($row->paid),0,1,'C');
...
$pdf->SetFont('Arial','BI',7);
$pdf->Cell(1,8 ,'Kes '. number_format($row->due),0,1,'C');

//////////////////////////////////////////////
$pdf->SetY(120);
$pdf->SetX(7);
$pdf->SetFont('Arial','BU',5);
$pdf->Cell(75,4 ,'Returns Not Accepted Without Purchase Note',0,1,'L');

$pdf->SetFont('Arial','BU',5);
$pdf->Cell(45,4 ,'Returns Accepted Maximum 3 Days After Purchase',0,0,'C');
