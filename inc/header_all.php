...
<head>
  ...
  <title>GEN-SHOP | Dashboard</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a class="logo">
        ...
        <span class="logo-lg"><b>GENERAL SHOP | </b>POS</span>
      </a>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li><a href="./register.php"><i class="fa fa-users"></i> <span>App Users</span></a></li>
          <li><a href="./product.php"><i class="fa fa-archive"></i> <span>Product</span></a></li>
          <li><a href="./order.php"><i class="fa fa-shopping-cart"></i> <span>Sales</span></a></li>
